...
with open('C://Users//Marzena//Documents//fortuna 05112020.csv', newline='') as datafile:
...
print(calc_equilibrium(1.09, 8))
print(calc_equilibrium(2.02, 1.69))
print(calc_equilibrium(1.92, 1.98))
print(calc_equilibrium(1.89, 2.01))
print(calc_equilibrium(1.8, 2.03))
